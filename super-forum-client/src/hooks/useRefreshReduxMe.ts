...
// The origin purpose of program is define data and operation of data. You should think all program as to origin purpose to reduce info load.
// otherwise, along with your landscape also is important.
